...
english_txt = open("/tmp/pycharm_project_78/submission-code/src/submission_code/nl2cmd/invocations.txt",
                   encoding="utf8").read().split("\n")
bash_txt = open("/tmp/pycharm_project_78/submission-code/src/submission_code/nl2cmd/cmds.txt",
                encoding="utf8").read().split("\n")
...
outF = open("/tmp/pycharm_project_78/submission-code/src/submission_code/nl2cmd/invocations_proccess.txt", "w")
