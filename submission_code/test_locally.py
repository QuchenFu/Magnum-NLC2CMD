...
if __name__ == "__main__":
    ...
    default_annotation_filepath = os.path.join(os.path.dirname(__file__), 'configs', 'annotations',
                                               'local_eval_annotations.json')
    ...
    parser.add_argument('--annotation_filepath', type=str, required=False, default=default_annotation_filepath,
                        help="Annotation filepath")
    parser.add_argument('--params_filepath', type=str, required=False, default=default_params_filepath,
                        help="Parameters filepath")
    parser.add_argument('--grammar_filepath', type=str, required=False, default=default_grammar_filepath,
                        help="Grammar filepath")
    parser.add_argument('--log_folder', type=str, required=False, default=default_logfolder,
                        help="Output log folder path")
